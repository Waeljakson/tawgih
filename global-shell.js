...
(function(global){
  ...
  function build(){
    ...
    ensureCss(A('global-shell.css?v=1.0.23'),'mgsGlobalCss');
  ...
  async function loadServices(){
    ensureCss(A('smart-reminders.css?v=1.0.23'),'mgsReminderCss');ensureCss(A('support-widget.css?v=1.0.23'),'mgsSupportCss');
    await loadScript(A('bubble-schema.js?v=1.0.23'),'MISHKAT_BUBBLE_SCHEMA');
    await loadScript(A('bubble-config.js?v=1.0.23'),'MISHKAT_BUBBLE_CONFIG');
    await loadScript(A('school-context.js?v=1.0.23'),'MishkatSchoolContext');
    await loadScript(A('bubble-persistence.js?v=1.0.23'),'MishkatBubbleStore');
    await loadScript(A('school-directory.js?v=1.0.23'),'MishkatBubbleDirectory');
    if(!global.__guidanceSmartRemindersLoaded)await loadScript(A('smart-reminders.js?v=1.0.23'),'__guidanceSmartRemindersLoaded');
    if(!global.__unifiedSupportWidgetLoaded)await loadScript(A('support-widget-rest.js?v=1.0.23'),'__unifiedSupportWidgetLoaded');
