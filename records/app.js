...
function applyAccountUI(){
  ...
  if(el.schoolProfileName)el.schoolProfileName.value=school;if(el.profileFullName)el.profileFullName.value=displayName;if(el.profileCampusName)el.profileCampusName.value=ctx.campus||"";if(el.profileStageName)el.profileStageName.value=ctx.stage||"";if(el.profileManagerName)el.profileManagerName.value=ctx.managerName||"";if(el.profileSchoolType)el.profileSchoolType.value=ctx.schoolTypeLabel||"بنين";
