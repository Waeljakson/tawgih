...
const RECORDS = {
  ...
  daily_incident: {
    ...
    studentKey: "student_name", classKey: "class_name", sections: [
      section("بيانات الموقف", [f("student_name","اسم الطالب","text",{span:6,required:true}),f("class_name","الفصل","text",{span:3}),f("incident_date","التاريخ","date",{span:3}),f("incident_category","نوع الموقف","radio",{options:["سلوكي","تعليمي"]}),f("behavior_code","الموقف السلوكي","select",{span:6,options:["",...DAILY_BEHAVIOR_CODES]}),f("education_code","الموقف التعليمي","select",{span:6,options:["",...DAILY_EDUCATION_CODES]}),f("referral_source","مصدر الإحالة","select",{span:6,options:[""],help:"يتم تحميل أسماء الموظفين تلقائيًا، ويظهر اسم الموظف فقط."}),f("action_codes","الإجراءات المتخذة","checklist",{options:DAILY_ACTION_CODES}),f("incident_details","تفاصيل الموقف","textarea",{span:12,rows:5}),f("notes","ملاحظات","textarea",{span:12,rows:3})]),
...
function renderField(field){
  ...
  if(field.key==="principal_name")field={...field,value:ctx.managerName||field.value||"",linkedReadonly:true,help:"مدير المدرسة المحدد من الإعدادات"};
